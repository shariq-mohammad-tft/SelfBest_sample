...
@Composable
fun CardReceiverMessage(message: String, timestamp: String, botName: String) {
...
@Composable
fun CardlinksMessage(message: ArrayList<String>, timestamp: String, botName: String) {
    Column(
        modifier = Modifier
            .fillMaxWidth()
            .padding(horizontal = 8.dp, vertical = 4.dp),
...
fun CardReceiverMessagePreview() {
    CardReceiverMessage("Cool", "time", "Bot")
}
