...
class StatisticsViewModel @Inject constructor(
    ...
    private val queryAnsweredLiveData = MutableLiveData<NetworkResponse<List<QueryAnsweredResponse>>>()
    val queryAnsweredObserver: LiveData<NetworkResponse<List<QueryAnsweredResponse>>> = queryAnsweredLiveData
