...
import com.tft.selfbest.ui.fragments.activityLog.RadarChart;
        ...
        for (int i = 0; i < mChart.getData().getDataSetCount(); i++) {
            ...
            for (int j = 0; j < dataSet.getEntryCount(); j++) {
                ...
                if (dataSet.isDrawValuesEnabled()) {
                    drawValue(c,
                            String.valueOf(dataSet.getValueFormatter()),
                            entry.getY(),
                            pOut.x,
...
//            }
    ...
    public void drawHighlightCircle(Canvas c, MPPointF point,
                                    float innerRadius,
                                    float outerRadius,
                                    int fillColor,
                                    int strokeColor,
