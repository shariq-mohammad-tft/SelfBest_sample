...
class ProfileFragment : Fragment(), AdapterView.OnItemSelectedListener, View.OnClickListener,
    ...
    companion object {
        ...
        private const val GMAIL_REDIRECT_URL =
            "https://staging.self.best/user/profile?show=integration"
    }
...
//        Log.e("Image : ",""+profileData.image)
        ...
        if (profileData.simplifypath!! && profileData.integratedTools != null) {
            if (profileData.integratedTools!!.keka == true) {
                binding.keka.visibility = View.VISIBLE
                if (profileData.deviceConnected!!.keka == true) {
                    binding.isKekaConnected.visibility = View.VISIBLE
                    binding.kekaNotConnected.visibility = View.GONE
                } else {
                    binding.isKekaConnected.visibility = View.GONE
                    binding.kekaNotConnected.visibility = View.VISIBLE
                }
            }

            if (profileData.integratedTools!!.googleCalendar == true) {
                binding.googleCalendar.visibility = View.VISIBLE
                if (profileData.deviceConnected!!.googleCalendar == true || profileData.importGoogleCalendar == true) {
                    binding.isGoogleCalConnected.visibility = View.VISIBLE
                    binding.googleCalNotConnected.visibility = View.GONE
                } else {
                    binding.isGoogleCalConnected.visibility = View.GONE
                    binding.googleCalNotConnected.visibility = View.VISIBLE
                }
            }

            if (profileData.integratedTools!!.microsoftCalendar == true) {
                binding.microsoftCalendar.visibility = View.VISIBLE
                if (profileData.deviceConnected!!.microsoftCalendar == true) {
                    binding.isMicrosoftCalConnected.visibility = View.VISIBLE
                    binding.msCalNotConnected.visibility = View.GONE
                } else {
                    binding.isMicrosoftCalConnected.visibility = View.GONE
                    binding.msCalNotConnected.visibility = View.VISIBLE
                }
            }

            if (profileData.integratedTools!!.jira == true) {
                binding.jira.visibility = View.VISIBLE
                if (profileData.deviceConnected!!.jira == true) {
                    binding.isJiraConnected.visibility = View.VISIBLE
                    binding.jiraNotConnected.visibility = View.GONE
                } else {
                    binding.isJiraConnected.visibility = View.GONE
                    binding.jiraNotConnected.visibility = View.VISIBLE
                }
            }

            if (profileData.integratedTools!!.freshwork == true) {
                binding.freshwork.visibility = View.VISIBLE
                if (profileData.deviceConnected!!.freshwork == true) {
                    binding.isFreshworkConnected.visibility = View.VISIBLE
                    binding.freshworkNotConnected.visibility = View.GONE
                } else {
                    binding.isFreshworkConnected.visibility = View.GONE
                    binding.freshworkNotConnected.visibility = View.VISIBLE
                }
            }

            if (profileData.integratedTools!!.salesforce == true) {
                binding.salesforce.visibility = View.VISIBLE
                if (profileData.deviceConnected!!.salesforce == true) {
                    binding.isSalesforceConnected.visibility = View.VISIBLE
                    binding.salesforceNotConnected.visibility = View.GONE
                } else {
                    binding.isSalesforceConnected.visibility = View.GONE
                    binding.salesforceNotConnected.visibility = View.VISIBLE
                }
            }

            if (profileData.integratedTools!!.gmail == true) {
                binding.gmail.visibility = View.VISIBLE
                if (profileData.deviceConnected!!.gmail == true) {
                    binding.isGmailConnected.visibility = View.VISIBLE
                    binding.gmailNotConnected.visibility = View.GONE
                } else {
                    binding.isGmailConnected.visibility = View.GONE
                    binding.gmailNotConnected.visibility = View.VISIBLE
                }
            }

            if (profileData.integratedTools!!.dbf == true) {
                binding.dbf.visibility = View.VISIBLE
                if (profileData.deviceConnected!!.dbf == true) {
                    binding.isDbfConnected.visibility = View.VISIBLE
                    binding.dbfNotConnected.visibility = View.GONE
                } else {
                    binding.isDbfConnected.visibility = View.GONE
                    binding.dbfNotConnected.visibility = View.VISIBLE
                }
            }
        } else if (profileData.integratedTools != null) {
            if (profileData.integratedTools!!.googleCalendar == true) {
                binding.googleCalendar.visibility = View.VISIBLE
                if (profileData.deviceConnected!!.googleCalendar == true || profileData.importGoogleCalendar == true) {
                    binding.isGoogleCalConnected.visibility = View.VISIBLE
